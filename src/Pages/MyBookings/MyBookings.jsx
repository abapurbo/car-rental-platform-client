...
export default function MyBookings() {
  // Fake booking data (from your example)
  const bookings = [
    {
...
>
  ...
  <div className="flex items-center gap-5">
    <img
      ...
      className="w-28 h-24 object-contain rounded-xl border border-gray-300 shadow-sm bg-white"
    />
    <div>
  ...
  <div className="flex flex-col items-start md:items-end gap-3">
    <span
      className={`px-4 py-1.5 text-sm font-semibold rounded-full border shadow-sm ${
